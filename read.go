...
func (r *reader) readIndexData(toc *indexTOC) (*indexData, error) {
	...
	if d.metaData.IndexFeatureVersion < ReaderMinFeatureVersion {
		return nil, fmt.Errorf("file is feature version %d, want feature version >= %d", d.metaData.IndexFeatureVersion, ReaderMinFeatureVersion)
	}
