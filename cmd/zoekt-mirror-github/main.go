...
func updateConfig(destDir string, r *github.Repository) error {
	...
	for k, v := range map[string]string{
		"github_stars":       strconv.Itoa(*r.StargazersCount),
		"github_watchers":    strconv.Itoa(*r.WatchersCount),
		"github_subscribers": strconv.Itoa(sub),
		"github_forks":       strconv.Itoa(*r.ForksCount),
	} {
